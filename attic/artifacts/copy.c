...
error_1_source:
    ...
    syscall3(1, 2, (long)"copy: 1: source \"lorem_ipsum.txt\": ", 35);
...
error_2_sink:
    ...
    syscall3(1, 2, (long)"copy: 2: sink \"copy_out.txt\": ", 30);
...
error_3_read_source:
    ...
    syscall3(1, 2, (long)"copy: 3: read source: ", 22);
    _write_value(count);
    _status = 1;
...
error_4_write_sink:
    ...
    syscall3(1, 2, (long)"copy: 4: write sink: ", 21);
