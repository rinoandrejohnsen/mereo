...
error_1:
    syscall3(1, 2, (long)"switch: 1: read input: ", 23);
    _write_value(count);
    _status = 1;
...
error_2:
    syscall3(1, 2, (long)"switch: 2: write terminal \"nothing\\n\": ", 39);
...
error_3:
    syscall3(1, 2, (long)"switch: 3: write terminal \"one byte\\n\": ", 40);
    _write_value(written);
    _status = 1;
...
error_4:
    syscall3(1, 2, (long)"switch: 4: write terminal \"many bytes\\n\": ", 42);
    _write_value(written);
    _status = 1;
